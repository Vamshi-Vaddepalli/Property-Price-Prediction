...
if st.button('Predict'):
    ...
    margin_pct = 0.22                         # this is 22%
    margin_amount = base_price * margin_pct   # 22% of the price, in Cr
    low = base_price - margin_amount           # subtract that amount
    high = base_price + margin_amount          # add that amount
